...
describe('switchStatus Server Action (Schema: startaii)', () => {
    ...
    it('SUCCESS: should switch status from ACTIVE to BANNED', async () => {
        ...
        const result = await switchStatus(TEACHER_ID, SCHEMA);
    ...
    it('NOT FOUND: should return code 1 if teacher does not exist', async () => {
    ...
    it('VALIDATION: should return error if teacherId is missing', async () => {
